        ...
        <div className="header__top">
          ...
          <div className="header__top-right">
            <div className='header__btn-wrapper'>
              <span className='header__cart_icon'>
                <svg fill="#1e4275" height="24px" width="24px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 335.302 335.302" xml:space="preserve">
<g>
	...
	<path d="M221.17,257h-202c-8.284,0-15,6.716-15,15s6.716,15,15,15h8.781c-2.128,4.416-3.321,9.364-3.321,14.585
		...
		c0-5.221-1.193-10.169-3.321-14.585h4.898c8.284,0,15-6.716,15-15S229.454,257,221.17,257z"/>
              ...
              <div className='header__signup_wrapper'><span>Sign Up</span><span>sign In</span></div>
            </div>
          </div>
